...
.about-story .story-visual i { font-size: 96px; color: #0d6efd; opacity: .85; }
...
.value-card {
    background: #fff; border-radius: 18px; padding: 32px 24px; text-align: left;
...
.value-card b { display: block; font-size: 16px; font-weight: 700; color: #000; margin-bottom: 8px; }
.value-card p { color: #777; font-size: 14px; line-height: 1.6; margin: 0; }
...
.timeline-item p { color: #666; font-size: 14.5px; margin: 0; line-height: 1.6; }
